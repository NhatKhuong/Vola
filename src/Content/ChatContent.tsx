...
import { oppenModal, oppenModalProfile } from "../redux/statusCommon/slice";
        ...
        <div className={style.chatContent}>
            <div className={style.chatContentHeader}>
                <div className={style.chatContentHeader_left}>
                    <img src={roomState.lstChat[0]?.user.avatar} alt="" onClick={() => dispatch(oppenModalProfile())}/>
                    <FriendProfile isShare={true} />
