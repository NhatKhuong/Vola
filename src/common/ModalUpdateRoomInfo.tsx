    ...
    async function handleUpdate() {
        try {
            ...
            if (file) {
                ...
                axios
                    .patch(
                        `https://frozen-caverns-53350.herokuapp.com/api/rooms/${roomId}/avatar`,
                        formData,
                        {
                            headers: {
                                authorization: token!,
            ...
            >
                <div className={style.Modal_createGroup}>
                    ...
                    <div className="" style={{ fontSize: "14px" }}>
                        Bạn có chắc muốn thây đổi thông tin cuộc hội thoại, khi
                        xác nhận thông tin hội thoại mới sẽ hiển thị với tất cả
                        thành viên
                    </div>
                    ...
                    <div
                        className={style.Modal_footer}
                        style={{ border: "none" }}
                    >
                        <button
                            className={style.btn_modal_cancel}
                            onClick={close}
                        >
                            Hủy
                        </button>
