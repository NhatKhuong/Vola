...
function ModalSearch() {
    ...
    function handelClick(e:any){
        ...
        dispatch(infoAPI.updateInfo()({email:e.email,avatar:e.avatar,_id:e._id}))
    }
    ...
    const handelSearch = async () => {
        try {
            ...
            var user: any = await axios.get(`http://localhost:5000/api/users/email/${email}`, {
                ...
                <div className={style.Modal_createGroup}>
                    ...
                    <div className={style.Modal_createGroup_body}>
                        <div className={style.input_search_block}>
                            <input placeholder='Nhập số Email cần tìm' className={style.Modal_Input_search} type="text" onKeyUp={onKeyUpValue} />
                        </div>
                        <div className={style.result_search_list_container}>
                            {
                                listResult.map((e:any) => {
                                    return (
                                        <div className={style.result_search_list_item} onClick={()=>handelClick(e)}>
                                            <img className={style.image} src={e.avatar || "https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_960_720.png"} alt="" />
                                            <div className={style.info}>
                                                <div className="" style={{ fontSize: "14px" }}>{e.email}</div>
                    ...
                    <div className={style.Modal_createGroup_footer}>
                        <div style={{ float: "right" }}>
                            ...
                            <button style={{ backgroundColor: "#0068ff", color: "#fff", width: "100px", height: "26px", fontSize: "12px", borderRadius: "3px", marginLeft: "20px" }} onClick={handelSearch}>Tìm kiếm</button>
                        </div>
                    </div>
