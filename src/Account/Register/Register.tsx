  ...
  const handleRegister = async (e: FormEvent) => {
    ...
    singUpWithEmailAndPassword(email, password)
      .then((user: any) => {
        ...
        alert("Đăng ký thành công vui lòng kiểm tra hộp thư của bạn");
        navigate("/login");
      })
      .catch((error: any) => {
        console.log(error);
  ...
  return (
    <div className="limiter">
      ...
      <div className="container-login100">
        <div
          className="wrap-login100 p-l-20 p-r-20 p-t-20 p-b-20"
          style={{ height: "110vh", width: "400px" }}
        >
          <form
            ...
            id="form_register"
          >
            <span className="login100-form-title p-b-20">Zalo</span>
            ...
            >
              ...
              <div style={{ display: "flex" }}>
                <Input
                  ...
                  name="comfpassword"
                  value={comfpassword}
                  onChange={(e: any) => setComfpassword(e.target.value)}
                  rule="required"
                  id="comfpassword"
                />

                {showcomfpassword === "password" ? (
                  <AiFillEye onClick={() => setShowcomfpassword("text")} />
                ) : (
                  <AiFillEyeInvisible
                    onClick={() => setShowcomfpassword("password")}
                  />
                )}
              </div>
              {/* <span className="focus-input100" data-symbol="&#xf190;"></span> */}
