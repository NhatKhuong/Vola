                    ...
                    <div className={style.listRequestAddFriend_item}>
                      <div className={style.listRequestAddFriend_item_info}>
                        <div className={style.listRequestAddFriend_item_img}>
                          <img src={e.avatar || "https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_960_720.png"} alt="" />
                        </div>
                        <div style={{ fontSize: "14px" }}>{e.userId.email}</div>
                      </div>
                      <div className={style.listRequestAddFriend_item_btn}>
                        ...
                        <button style={{ marginLeft: "10px", width: "100px", fontSize: "14px", borderRadius: "5px", height: "30px", border: "1px solid #ccc", backgroundColor: "#0068ff", color: "#fff" }} onClick={()=>handelAddFriend(e.userId._id)}>Chấp nhận</button>
                      </div>
                    </div>
                  )
                })
